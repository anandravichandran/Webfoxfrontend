  ...
  return (
    <div className='relative z-20'>
      <div className='w-full max-w-screen-xl mx-auto px-4 sm:px-8 lg:px-16 pt-24'>
        ...
        Make Phishing Detection Effortless
        </motion.h1>
        ...
        As online threats evolve, our spoof finder scales with cutting-edge machine learning and deep learning algorithms, keeping your browsing experience safe and smooth.
        </motion.p>
                ...
                <motion.li variants={list}>
                  <button className='text-white flex gap-4 items-center text-left relative'>
                    ...
                    <div className='relative bg-gradient-to-br from-zinc-100 to-zinc-50 h-5 w-5 rounded-md p-px'>
                      ...
                      <div>
                        <div className='font-light text-zinc-300'>URL Scanning</div>
                        <div className='text-xs text-zinc-400'>Thoroughly analyzes the link, checking for malicious patterns, suspicious domains, and Impersonation Scams markers</div>
                      </div>
                  </button>
                </motion.li>
                <motion.li variants={list}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 8 16" className="fill-current h-3 ml-2 text-zinc-600 -translate-x-px"><path fillRule="evenodd" clipRule="evenodd" d="M4 0C4.41422 0 4.75 0.335786 4.75 0.75V13.3401L6.70041 11.2397C6.98226 10.9361 7.45681 10.9186 7.76034 11.2004C8.06387 11.4823 8.08145 11.9568 7.7996 12.2603L4.5496 15.7603C4.40769 15.9132 4.20855 16 4 16C3.79145 16 3.59232 15.9132 3.45041 15.7603L0.200408 12.2603C-0.081444 11.9568 -0.0638681 11.4823 0.239665 11.2004C0.543198 10.9186 1.01775 10.9361 1.2996 11.2397L3.25 13.3401V0.75C3.25 0.335786 3.58579 0 4 0Z"></path></svg>
                  <button className='text-white flex gap-4 items-center text-left relative'>
                    ...
                    <div className='relative bg-gradient-to-br from-zinc-100 to-zinc-50 h-5 w-5 rounded-md p-px'>
                      ...
                      <div>
                        <div className='font-light text-zinc-300'>Retry Mechanism</div>
                        <div className='text-xs text-zinc-400'>Rechecks suspicious sites with advanced heuristics to avoid misidentification.</div>
                      </div>
                  </button>
                </motion.li>
                <motion.li variants={list}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 8 16" className="fill-current h-3 ml-2 text-zinc-600 -translate-x-px"><path fillRule="evenodd" clipRule="evenodd" d="M4 0C4.41422 0 4.75 0.335786 4.75 0.75V13.3401L6.70041 11.2397C6.98226 10.9361 7.45681 10.9186 7.76034 11.2004C8.06387 11.4823 8.08145 11.9568 7.7996 12.2603L4.5496 15.7603C4.40769 15.9132 4.20855 16 4 16C3.79145 16 3.59232 15.9132 3.45041 15.7603L0.200408 12.2603C-0.081444 11.9568 -0.0638681 11.4823 0.239665 11.2004C0.543198 10.9186 1.01775 10.9361 1.2996 11.2397L3.25 13.3401V0.75C3.25 0.335786 3.58579 0 4 0Z"></path></svg>
                  <button className='text-white flex gap-4 items-center text-left relative'>
                    ...
                    <div className='relative bg-gradient-to-br from-zinc-100 to-zinc-50 h-5 w-5 rounded-md p-px'>
                      ...
                      <div>
                        <div className='font-light text-zinc-300'>Timeout Protection</div>
                        <div className='text-xs text-zinc-400'>Halts the scan after 2 seconds if the link behaves unusually, preventing overuse of resources.</div>
                      </div>
                  </button>
                </motion.li>
                <motion.li variants={list}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 8 16" className="fill-current h-3 ml-2 text-zinc-600 -translate-x-px"><path fillRule="evenodd" clipRule="evenodd" d="M4 0C4.41422 0 4.75 0.335786 4.75 0.75V13.3401L6.70041 11.2397C6.98226 10.9361 7.45681 10.9186 7.76034 11.2004C8.06387 11.4823 8.08145 11.9568 7.7996 12.2603L4.5496 15.7603C4.40769 15.9132 4.20855 16 4 16C3.79145 16 3.59232 15.9132 3.45041 15.7603L0.200408 12.2603C-0.081444 11.9568 -0.0638681 11.4823 0.239665 11.2004C0.543198 10.9186 1.01775 10.9361 1.2996 11.2397L3.25 13.3401V0.75C3.25 0.335786 3.58579 0 4 0Z"></path></svg>
                  <button className='text-white flex gap-4 items-center text-left relative'>
                    ...
                    <div className='relative bg-gradient-to-br from-zinc-100 to-zinc-50 h-5 w-5 rounded-md p-px'>
                      ...
                      <div>
                        <div className='font-light text-zinc-300'>Comprehensive Logging</div>
                        <div className='text-xs text-zinc-400'>Keeps a detailed record of each scan, providing insights into the Malicious Link Distribution attempt and offering real-time feedback.</div>
                      </div>
                  </button>
                </motion.li>
              </motion.ul>
